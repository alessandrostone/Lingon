...
{
	return [NSArray arrayWithObjects:@"LINNewToolbarItem", @"LINSaveToolbarItem", @"LINPreferencesToolbarItem", NSToolbarFlexibleSpaceItemIdentifier, NSToolbarSpaceItemIdentifier, NSToolbarSeparatorItemIdentifier, nil];
}

- (NSArray *)toolbarDefaultItemIdentifiers:(NSToolbar *)toolbar  
{
	return [NSArray arrayWithObjects:@"LINNewToolbarItem", NSToolbarSpaceItemIdentifier, @"LINSaveToolbarItem", NSToolbarFlexibleSpaceItemIdentifier, @"LINPreferencesToolbarItem", nil];
}
