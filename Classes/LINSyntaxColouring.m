...
{	
	@try { 
		...
		// If there are any exceptions raised by this section just pass through and stop colouring instead of throwing an exception and refuse to load the textview 
		...
		while (![scanner isAtEnd]) {
			...
			if (beginning >= completeStringLength) 
				break;
