...
@implementation LINGradientBackgroundView
...
{	
	...
	[[NSColor colorWithDeviceWhite:0.59 alpha:1.0] set];
    [NSBezierPath setDefaultLineWidth:1];
    [NSBezierPath strokeRect:NSMakeRect(gradientRect.origin.x * scaleFactor, 0, gradientRect.size.width * scaleFactor, 0.5 * scaleFactor)];
}
